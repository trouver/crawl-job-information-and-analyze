...
fig = plt.figure('区域分布详情', figsize=[10, 5])
...
fig = plt.figure('平均工作经验统计详情', figsize=[12, 5])
plt.subplots_adjust(left=0.03, bottom=0.15, right=0.97, top=0.9, wspace=0.2)
...
fig = plt.figure('学历要求详情', figsize=[10, 5])
